...
public class Ristic extends Container
{
	...
	@Override
	public boolean isStepProductive()	{ return (true); }
	@Override
	...
	public boolean isDotRistic()				{ return (false); }
	public boolean isRisticClass()				{ return (false); }
	public boolean isRisticInstance()			{ return (false); }
	public boolean isUnboundRistic()			{ return (true); }
	
	@Override
	public boolean isRistic()		{ return (true); }
	@Override
	...
	static abstract public class RisticClass extends RisticType
	{
		public RisticClass(Symbol name, ParserPoint point)
			{  super(Elements.EmptyElements, point); _name = name;  }
	...
	static abstract public class RisticInstance extends RisticType
	{
		public RisticInstance(RisticClass rClass, Elements elements, ParserPoint point)
			{  super(elements, point); _rClass = rClass;  }
		...
		public void print(StringBuilder sb) 
		{
			sb.append("("); _rClass.print(sb); sb.append(' ');
			List[] es = _elements.asArray();
			for (List e : es) 
				{ e.print(sb); sb.append(" "); }
			sb.append(")");
	...
	static public StringBuilder risticClassName(StringBuilder sb, Class rClass)
	{
		...
		if (name != null)
			{ sb.append(name.asjString()); return(sb); }
		sb.append("(.ristic #")
	...
	static public class DotRistic extends RisticClass
	{
		...
		@Override
		public boolean isDotRistic()	{ return (true); }
